...
pub fn early_kernel_init_with_context(context: &BootContext) {
    ...
    crate::debug::debug_marker("RIAN: ENTRY");
    ...
    crate::debug::debug_marker("RIAN: BOOT CONTEXT OK");

    crate::debug::debug_marker("RIAN: ARCH INIT");
    crate::arch::early_arch_init();

    crate::debug::debug_marker("RIAN: MM INIT");
    ...
    crate::debug::debug_marker("RIAN: SECURITY INIT");
    crate::security::early_security_init();

    crate::debug::debug_marker("RIAN: IPC INIT");
    crate::ipc::early_ipc_init();

    crate::debug::debug_marker("RIAN: SCHED INIT");
    crate::sched::early_sched_init();

    crate::debug::debug_marker("RIAN: PROCESS INIT");
    let kernel_process_id = crate::process::early_process_init();

    crate::debug::debug_marker("RIAN: THREAD INIT");
    crate::thread::early_thread_init(kernel_process_id);

    crate::debug::debug_marker("RIAN: HALT");
